...
logger.info(f"Trajectory Generated: {result.success}")
logger.info(f"Start State: {start_state}")
logger.info(f"Goal Pose: {goal_pose}")
logger.info(f"Trajectory: {traj[-1]}")
